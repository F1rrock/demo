...
public final class GetAllServices extends ServiceCase<ServiceEntity, Void> {
    public GetAllServices(ServiceRepository repository) {
        super(repository);
    }

    @Override
    public Either<Failure, List<ServiceEntity>> call(Void unused) {
