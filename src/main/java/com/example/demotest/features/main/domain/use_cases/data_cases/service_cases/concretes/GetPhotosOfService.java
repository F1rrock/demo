...
public final class GetPhotosOfService extends ServiceCase<String, ServiceEntity> {
    public GetPhotosOfService(ServiceRepository repository) {
        super(repository);
    }

    @Override
    public Either<Failure, List<String>> call(ServiceEntity service) {
        return repository.selectPhotoPaths(service);
    }
}
